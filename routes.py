...
def create_post(thread_id):
    ...
    return render_template("create_post.html", form=form, thread_id=thread_id)
...
def create_comment(thread_id, post_id):
    ...
    return render_template("create_comment.html", form=form, thread_id=thread_id, post_id=post_id)
